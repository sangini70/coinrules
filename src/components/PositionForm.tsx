...
export default function PositionForm() {
  ...
  return (
    <div className="space-y-5 p-4 sm:space-y-6 sm:p-5 lg:p-7">
      <section className="grid gap-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm ring-1 ring-gray-100 md:grid-cols-[minmax(0,1fr)_auto] md:items-center sm:gap-5 sm:p-6">
        <div className="space-y-3">
          ...
          <div className="text-sm font-semibold tracking-tight text-gray-600 sm:text-base">현재 가격: {String(firstSignal?.currentPrice ?? "-")}</div>
        </div>
      ...
      <section className="rounded-2xl border border-gray-200 bg-gray-50/70 p-4 shadow-sm ring-1 ring-gray-100 sm:p-5">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm ring-1 ring-gray-100 sm:p-5">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <button
            type="button"
            className={`inline-flex cursor-pointer items-center rounded-full border px-3 py-1.5 text-sm font-semibold transition duration-200 ${visualActive ? "border-emerald-300 bg-emerald-50 text-emerald-700 shadow-sm" : "border-gray-200 bg-white text-gray-600 hover:bg-gray-50"}`}
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          <button
            type="button"
            className={`inline-flex cursor-pointer items-center rounded-full border px-4 py-2 text-sm font-semibold transition duration-200 ${entryVisualActive ? "border-blue-300 bg-blue-50 text-blue-700 shadow-sm" : "border-gray-200 bg-white text-gray-600 hover:bg-gray-50"}`}
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3">
          <button
            type="button"
            className={`inline-flex cursor-pointer items-center rounded-full border px-4 py-2 text-sm font-semibold transition duration-200 ${buyVisualActive ? "border-emerald-300 bg-emerald-50 text-emerald-700 shadow-sm" : "border-gray-200 bg-white text-gray-600 hover:bg-gray-50"}`}
          ...
          <button
            type="button"
            className={`inline-flex cursor-pointer items-center rounded-full border px-4 py-2 text-sm font-semibold transition duration-200 ${sellVisualActive ? "border-rose-300 bg-rose-50 text-rose-700 shadow-sm" : "border-gray-200 bg-white text-gray-600 hover:bg-gray-50"}`}
      ...
      <section className="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm ring-1 ring-gray-100 divide-y divide-gray-100">
        <header className="border-b border-gray-100 px-4 py-4 sm:px-5">
          <div className="text-lg font-bold tracking-tight text-gray-900 sm:text-xl">실시간 신호 요약</div>
          <div className="mt-1 text-xs font-medium uppercase tracking-[0.2em] text-gray-400">read-only signal info</div>
        </header>

        <div className="grid gap-4 p-4 sm:grid-cols-2 sm:gap-3 sm:p-5">
          <div className="rounded-xl border border-gray-100 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700 sm:col-span-2">
            코인: {String(firstSignalKey)}
          </div>
          <div className="rounded-xl border border-gray-100 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700">
            상태: {String(firstSignal?.state)}
          </div>
          <div className="rounded-xl border border-gray-100 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700">
