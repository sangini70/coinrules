...
export const en: Translation = {
  ...
  auto: "Current",
  rule_summary: "Entry Assessment",
  stop: "Stop Loss",
  take: "Take Profit",
  cooldown: "Cooldown",
  confirm_button: "Execute Entry",
  ...
  placeholder_buy_price: "Enter buy price",
  placeholder_amount: "Enter investment amount",
  state_WAIT: "Waiting for Re-entry",
  desc_WAIT: "Downtrend. Awaiting re-entry",
  state_OBSERVE: "Observe",
  desc_OBSERVE: "Trend maintained, but not an entry zone",
  state_CAUTION: "Caution Observation",
  desc_CAUTION: "Volume spike + rebound attempt. Verification needed",
  state_PREPARE: "Prepare Entry",
  desc_PREPARE: "Trend/Volume/Breakout aligned. Prepare for entry",
  state_RISK: "Maintain Risk Watch",
  desc_RISK: "Direction unclear. Maintain watch",
  evidence_trend_up: "Uptrend",
  evidence_volume_spike: "Volume Spike",
