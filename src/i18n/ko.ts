...
export const ko: Translation = {
  ...
  placeholder_buy_price: "매수가 입력",
  placeholder_amount: "투입 금액 입력",
  state_WAIT: "재진입 대기",
  desc_WAIT: "하락 흐름. 재진입 대기 유지",
  state_OBSERVE: "관찰",
  desc_OBSERVE: "추세는 유지되나 진입 판단 구간 아님",
  state_CAUTION: "주의 관찰",
  desc_CAUTION: "거래량 유입 + 반등 시도. 추가 확인 필요",
  state_PREPARE: "진입 준비 구간",
  desc_PREPARE: "추세·거래량·돌파 정렬. 재진입 준비 구간",
  state_RISK: "관망 유지",
  desc_RISK: "방향 불명확. 관망 유지",
  evidence_trend_up: "상승 추세",
  evidence_volume_spike: "거래량 유입",
  evidence_breakout: "저항 돌파",
};
